...
for lambda_ in lambda_list:
    ...
    for i in tqdm(range(num_runs), desc=f"lambda={lambda_}..."):
    ...
    result_df_low.to_csv("result_df_low_lambda_reg_usual_beta7.csv")
    result_df_high.to_csv("result_df_high_lambda_reg_usual_beta7.csv")
