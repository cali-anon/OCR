...
tanh_threshold_list = [-1.0, -0.75, -0.5, -0.25, 0.0, 0.25, 0.5, 0.75, 1.0]
...
for tanh_threshold in tanh_threshold_list:
    ...
    for i in tqdm(range(num_runs), desc=f"tanh_threshold={tanh_threshold}..."):
    ...
    result_df_low["tanh_threshold"] = tanh_threshold
    ...
    result_df_high["tanh_threshold"] = tanh_threshold
    ...
    result_df_low.to_csv("result_df_low_kuaisim5_val_threshold_seed.csv")
    result_df_high.to_csv("result_df_high_kuaisim5_val_threshold_seed.csv")
