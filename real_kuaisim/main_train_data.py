...
n_action = 300
epoch = 30
num_data_list = [500, 1000, 2000, 4000, 8000]
n_users = 300
n_category = 20
lambda_ = 0.3
random_state = 12345
...
for num_data in num_data_list:
    ...
    for i in tqdm(range(num_runs), desc=f"num_data={num_data}..."):
    ...
    result_df_low["num_data"] = num_data
    ...
    result_df_high["num_data"] = num_data
    ...
    result_df_low.to_csv("result_df_low_train_data_reg_usual_beta7.csv")
    result_df_high.to_csv("result_df_high_train_data_reg_usual_beta7.csv")
