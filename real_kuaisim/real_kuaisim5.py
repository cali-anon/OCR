...
for num_data in num_data_list:
    ...
    result_df_low.to_csv("result_df_low_kuaisim5_tanh_last_seed.csv")
    result_df_high.to_csv("result_df_high_kuaisim5_tanh_last_seed.csv")
